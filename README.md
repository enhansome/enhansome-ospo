...
* [(Corporate) Git Proxy](https://github.com/finos/git-proxy) ⭐ 240 | 🐛 104 | 🌐 TypeScript | 📅 2026-08-24 - Scan outgoing attempts to push to public repository and raise compliance/info-sec friendly checks before allowing the push to complete.
...
* [Linguist](https://github.com/github-linguist/linguist) ⭐ 13,656 | 🐛 227 | 🌐 Ruby | 📅 2026-08-24 - Identify the programming languages used in a project.
...
* [Licensee](https://github.com/licensee/licensee) ⭐ 905 | 🐛 7 | 🌐 Ruby | 📅 2026-08-24 - Identify a project's license file.
