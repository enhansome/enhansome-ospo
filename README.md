...
* [CLA Assistant](https://github.com/cla-assistant/cla-assistant) ⭐ 1,536 | 🐛 249 | 🌐 JavaScript | 📅 2024-06-06 - Streamline your workflow and let CLA assistant handle the legal side of contributions to a repository for you. CLA assistant enables contributors to sign CLAs from within a pull request.
...
* [devstats](https://github.com/cncf/devstats) ⭐ 129 | 🐛 12 | 🌐 Shell | 📅 2026-09-11 - A toolset to visualize GitHub archives using Grafana dashboards used by the Cloud Native Computing Foundation and Kubernetes.
...
* [Copybara](https://github.com/google/copybara) ⭐ 3,837 | 🐛 105 | 🌐 Java | 📅 2026-09-11 - A tool for transforming and moving code between repositories.
...
* [Sheriff](https://github.com/electron/sheriff) ⭐ 153 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-11 - Controls and monitors organization permissions across GitHub, Slack and GSuite.
...
* [Linguist](https://github.com/github-linguist/linguist) ⭐ 13,684 | 🐛 229 | 🌐 Ruby | 📅 2026-09-11 - Identify the programming languages used in a project.
...
* [DependencyTrack](https://github.com/DependencyTrack/dependency-track) ⭐ 4,194 | 🐛 1,085 | 🌐 Java | 📅 2026-09-11 - An intelligent component analysis platform that allows organizations to identify and reduce risk in the software supply chain.
* [ScanCode toolkit](https://github.com/aboutcode-org/scancode-toolkit) ⭐ 2,621 | 🐛 1,687 | 🌐 Python | 📅 2026-09-11 - Scan code for licenses, copyright and dependencies.
...
* [fossa-cli](https://github.com/fossas/fossa-cli) ⭐ 1,517 | 🐛 18 | 🌐 Haskell | 📅 2026-09-11 - Fast, portable and reliable dependency analysis for any codebase.
* [Licensed](https://github.com/licensee/licensed) ⭐ 1,047 | 🐛 3 | 🌐 Ruby | 📅 2026-09-09 - A Ruby gem to cache and verify the licenses of dependencies.
...
* [DefectDojo](https://github.com/defectdojo/django-defectdojo) ⭐ 4,937 | 🐛 223 | 🌐 Python | 📅 2026-09-11 - An OWASP flagship DevSecOps platform that streamlines the vulnerability management lifecycle by importing findings from 200+ security scanning tools, deduplicating them, and tracking remediation across products and engagements.
