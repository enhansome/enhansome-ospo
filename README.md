...
* [EasyCLA](https://github.com/linuxfoundation/easycla) ⭐ 79 | 🐛 105 | 🌐 Go | 📅 2026-08-21 - A Contributor License Agreement (CLA) service used in the Linux Foundation's LFX platform which lets project contributors read, sign, and submit contributor license agreements easily.
...
* [devstats](https://github.com/cncf/devstats) ⭐ 130 | 🐛 17 | 🌐 Shell | 📅 2026-08-24 - A toolset to visualize GitHub archives using Grafana dashboards used by the Cloud Native Computing Foundation and Kubernetes.
...
* [Copybara](https://github.com/google/copybara) ⭐ 3,808 | 🐛 105 | 🌐 Java | 📅 2026-08-24 - A tool for transforming and moving code between repositories.
...
* [opensource-management-portal](https://github.com/microsoft/opensource-management-portal) ⭐ 530 | 🐛 31 | 🌐 TypeScript | 📅 2026-08-21 - Microsoft's Open Source Portal for GitHub is a tool to help large organizations with GitHub management operations, onboarding and more. It is implemented in Node.js.
...
* [(Corporate) Git Proxy](https://github.com/finos/git-proxy) ⭐ 241 | 🐛 104 | 🌐 TypeScript | 📅 2026-08-24 - Scan outgoing attempts to push to public repository and raise compliance/info-sec friendly checks before allowing the push to complete.
...
* [Linguist](https://github.com/github-linguist/linguist) ⭐ 13,656 | 🐛 226 | 🌐 Ruby | 📅 2026-08-24 - Identify the programming languages used in a project.
...
* [DependencyTrack](https://github.com/DependencyTrack/dependency-track) ⭐ 4,136 | 🐛 1,072 | 🌐 Java | 📅 2026-08-24 - An intelligent component analysis platform that allows organizations to identify and reduce risk in the software supply chain.
* [ScanCode toolkit](https://github.com/aboutcode-org/scancode-toolkit) ⭐ 2,611 | 🐛 1,677 | 🌐 Python | 📅 2026-08-22 - Scan code for licenses, copyright and dependencies.
...
* [fossa-cli](https://github.com/fossas/fossa-cli) ⭐ 1,515 | 🐛 12 | 🌐 Haskell | 📅 2026-08-22 - Fast, portable and reliable dependency analysis for any codebase.
...
* [Licensee](https://github.com/licensee/licensee) ⭐ 906 | 🐛 7 | 🌐 Ruby | 📅 2026-08-24 - Identify a project's license file.
