...
* [EasyCLA](https://github.com/linuxfoundation/easycla) ⭐ 80 | 🐛 101 | 🌐 Go | 📅 2026-09-16 - A Contributor License Agreement (CLA) service used in the Linux Foundation's LFX platform which lets project contributors read, sign, and submit contributor license agreements easily.
...
* [devstats](https://github.com/cncf/devstats) ⭐ 130 | 🐛 13 | 🌐 Shell | 📅 2026-09-16 - A toolset to visualize GitHub archives using Grafana dashboards used by the Cloud Native Computing Foundation and Kubernetes.
...
* [Copybara](https://github.com/google/copybara) ⭐ 3,842 | 🐛 106 | 🌐 Java | 📅 2026-09-16 - A tool for transforming and moving code between repositories.
...
* [opensource-management-portal](https://github.com/microsoft/opensource-management-portal) ⭐ 534 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-10 - Microsoft's Open Source Portal for GitHub is a tool to help large organizations with GitHub management operations, onboarding and more. It is implemented in Node.js.
...
* [(Corporate) Git Proxy](https://github.com/finos/git-proxy) ⭐ 249 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-16 - Scan outgoing attempts to push to public repository and raise compliance/info-sec friendly checks before allowing the push to complete.
...
* [DependencyTrack](https://github.com/DependencyTrack/dependency-track) ⭐ 4,211 | 🐛 1,080 | 🌐 Java | 📅 2026-09-15 - An intelligent component analysis platform that allows organizations to identify and reduce risk in the software supply chain.
* [ScanCode toolkit](https://github.com/aboutcode-org/scancode-toolkit) ⭐ 2,623 | 🐛 1,687 | 🌐 Python | 📅 2026-09-11 - Scan code for licenses, copyright and dependencies.
...
* [fossa-cli](https://github.com/fossas/fossa-cli) ⭐ 1,518 | 🐛 17 | 🌐 Haskell | 📅 2026-09-15 - Fast, portable and reliable dependency analysis for any codebase.
...
* [DefectDojo](https://github.com/defectdojo/django-defectdojo) ⭐ 4,944 | 🐛 232 | 🌐 Python | 📅 2026-09-16 - An OWASP flagship DevSecOps platform that streamlines the vulnerability management lifecycle by importing findings from 200+ security scanning tools, deduplicating them, and tracking remediation across products and engagements.
