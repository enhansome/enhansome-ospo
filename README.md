...
* [CLA Assistant](https://github.com/cla-assistant/cla-assistant) ⭐ 1,536 | 🐛 248 | 🌐 JavaScript | 📅 2024-06-06 - Streamline your workflow and let CLA assistant handle the legal side of contributions to a repository for you. CLA assistant enables contributors to sign CLAs from within a pull request.
* [EasyCLA](https://github.com/linuxfoundation/easycla) ⭐ 80 | 🐛 103 | 🌐 Go | 📅 2026-09-08 - A Contributor License Agreement (CLA) service used in the Linux Foundation's LFX platform which lets project contributors read, sign, and submit contributor license agreements easily.
...
* [devstats](https://github.com/cncf/devstats) ⭐ 129 | 🐛 12 | 🌐 Shell | 📅 2026-09-07 - A toolset to visualize GitHub archives using Grafana dashboards used by the Cloud Native Computing Foundation and Kubernetes.
...
* [Copybara](https://github.com/google/copybara) ⭐ 3,831 | 🐛 105 | 🌐 Java | 📅 2026-09-08 - A tool for transforming and moving code between repositories.
...
* [opensource-management-portal](https://github.com/microsoft/opensource-management-portal) ⭐ 532 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-07 - Microsoft's Open Source Portal for GitHub is a tool to help large organizations with GitHub management operations, onboarding and more. It is implemented in Node.js.
...
* [(Corporate) Git Proxy](https://github.com/finos/git-proxy) ⭐ 248 | 🐛 98 | 🌐 TypeScript | 📅 2026-09-08 - Scan outgoing attempts to push to public repository and raise compliance/info-sec friendly checks before allowing the push to complete.
* [Stale Repos Action](https://github.com/github/stale-repos) ⭐ 204 | 🐛 2 | 🌐 Python | 📅 2026-09-03 - Get a regular report of inactive repositories in your organization so that you can choose to archive or revive.
* [Sheriff](https://github.com/electron/sheriff) ⭐ 153 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-04 - Controls and monitors organization permissions across GitHub, Slack and GSuite.
...
* [Linguist](https://github.com/github-linguist/linguist) ⭐ 13,682 | 🐛 225 | 🌐 Ruby | 📅 2026-09-07 - Identify the programming languages used in a project.
...
* [DependencyTrack](https://github.com/DependencyTrack/dependency-track) ⭐ 4,189 | 🐛 1,085 | 🌐 Java | 📅 2026-09-08 - An intelligent component analysis platform that allows organizations to identify and reduce risk in the software supply chain.
* [ScanCode toolkit](https://github.com/aboutcode-org/scancode-toolkit) ⭐ 2,618 | 🐛 1,682 | 🌐 Python | 📅 2026-09-04 - Scan code for licenses, copyright and dependencies.
* [LicensePlist](https://github.com/mono0926/LicensePlist) ⭐ 2,533 | 🐛 41 | 🌐 Swift | 📅 2026-07-28 - A command-line tool that automatically generates a Plist of all your dependencies, including files added manually (specified by YAML config file) or using Carthage or CocoaPods.
* [OSS Review Toolkit](https://github.com/oss-review-toolkit/ort) ⭐ 2,081 | 🐛 330 | 🌐 Kotlin | 📅 2026-09-08 - Enables highly automated and customizable open source compliance checks od the source code and dependencies of a project by scanning it, downloading its sources, reporting any errors and violations against user-defined rules, and by creating third-party attribution documentation.
* [LicenseFinder](https://github.com/pivotal/LicenseFinder) ⭐ 1,795 | 🐛 150 | 🌐 Ruby | 📅 2024-07-22 - Find licenses for your project's dependencies.
* [fossa-cli](https://github.com/fossas/fossa-cli) ⭐ 1,517 | 🐛 20 | 🌐 Haskell | 📅 2026-09-08 - Fast, portable and reliable dependency analysis for any codebase.
* [Licensed](https://github.com/licensee/licensed) ⭐ 1,047 | 🐛 4 | 🌐 Ruby | 📅 2026-08-09 - A Ruby gem to cache and verify the licenses of dependencies.
* [Licensee](https://github.com/licensee/licensee) ⭐ 912 | 🐛 7 | 🌐 Ruby | 📅 2026-09-07 - Identify a project's license file.
...
* [DefectDojo](https://github.com/defectdojo/django-defectdojo) ⭐ 4,925 | 🐛 215 | 🌐 Python | 📅 2026-09-08 - An OWASP flagship DevSecOps platform that streamlines the vulnerability management lifecycle by importing findings from 200+ security scanning tools, deduplicating them, and tracking remediation across products and engagements.
