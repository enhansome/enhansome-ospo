...
* [Copybara](https://github.com/google/copybara) ⭐ 3,856 | 🐛 106 | 🌐 Java | 📅 2026-09-25 - A tool for transforming and moving code between repositories.
...
* [opensource-management-portal](https://github.com/microsoft/opensource-management-portal) ⭐ 533 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-25 - Microsoft's Open Source Portal for GitHub is a tool to help large organizations with GitHub management operations, onboarding and more. It is implemented in Node.js.
...
* [(Corporate) Git Proxy](https://github.com/finos/git-proxy) ⭐ 253 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-25 - Scan outgoing attempts to push to public repository and raise compliance/info-sec friendly checks before allowing the push to complete.
