...
* [pull-request-size](https://github.com/noqcks/pull-request-size) ⭐ 177 | 🐛 16 | 🌐 JavaScript | 📅 2026-07-17 - Automatically adds GitHub labels based on the size of a pull request.
...
* [CLA Assistant](https://github.com/cla-assistant/cla-assistant) ⭐ 1,540 | 🐛 248 | 🌐 JavaScript | 📅 2024-06-06 - Streamline your workflow and let CLA assistant handle the legal side of contributions to a repository for you. CLA assistant enables contributors to sign CLAs from within a pull request.
...
* [devstats](https://github.com/cncf/devstats) ⭐ 130 | 🐛 13 | 🌐 Shell | 📅 2026-09-20 - A toolset to visualize GitHub archives using Grafana dashboards used by the Cloud Native Computing Foundation and Kubernetes.
...
* [Copybara](https://github.com/google/copybara) ⭐ 3,846 | 🐛 106 | 🌐 Java | 📅 2026-09-17 - A tool for transforming and moving code between repositories.
...
* [(Corporate) Git Proxy](https://github.com/finos/git-proxy) ⭐ 252 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-20 - Scan outgoing attempts to push to public repository and raise compliance/info-sec friendly checks before allowing the push to complete.
* [Stale Repos Action](https://github.com/github/stale-repos) ⭐ 205 | 🐛 2 | 🌐 Python | 📅 2026-09-17 - Get a regular report of inactive repositories in your organization so that you can choose to archive or revive.
...
* [Linguist](https://github.com/github-linguist/linguist) ⭐ 13,695 | 🐛 235 | 🌐 Ruby | 📅 2026-09-20 - Identify the programming languages used in a project.
...
* [DependencyTrack](https://github.com/DependencyTrack/dependency-track) ⭐ 4,224 | 🐛 1,083 | 🌐 Java | 📅 2026-09-20 - An intelligent component analysis platform that allows organizations to identify and reduce risk in the software supply chain.
* [ScanCode toolkit](https://github.com/aboutcode-org/scancode-toolkit) ⭐ 2,623 | 🐛 1,686 | 🌐 Python | 📅 2026-09-18 - Scan code for licenses, copyright and dependencies.
...
* [zanata](https://github.com/zanata/zanata-platform) ⭐ 339 | 🐛 71 | 🌐 Java | 📅 2025-09-22 - Web-based system for translators to translate documentation and software online using a web browser.
