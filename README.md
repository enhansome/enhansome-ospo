...
* [CLA Assistant](https://github.com/cla-assistant/cla-assistant) ⭐ 1,529 | 🐛 243 | 🌐 JavaScript | 📅 2024-06-06 - Streamline your workflow and let CLA assistant handle the legal side of contributions to a repository for you. CLA assistant enables contributors to sign CLAs from within a pull request.
* [EasyCLA](https://github.com/linuxfoundation/easycla) ⭐ 79 | 🐛 128 | 🌐 Go | 📅 2026-08-14 - A Contributor License Agreement (CLA) service used in the Linux Foundation's LFX platform which lets project contributors read, sign, and submit contributor license agreements easily.
...
* [devstats](https://github.com/cncf/devstats) ⭐ 130 | 🐛 16 | 🌐 Shell | 📅 2026-07-31 - A toolset to visualize GitHub archives using Grafana dashboards used by the Cloud Native Computing Foundation and Kubernetes.
...
* [Copybara](https://github.com/google/copybara) ⭐ 3,798 | 🐛 106 | 🌐 Java | 📅 2026-08-14 - A tool for transforming and moving code between repositories.
...
* [(Corporate) Git Proxy](https://github.com/finos/git-proxy) ⭐ 239 | 🐛 110 | 🌐 TypeScript | 📅 2026-08-17 - Scan outgoing attempts to push to public repository and raise compliance/info-sec friendly checks before allowing the push to complete.
* [Stale Repos Action](https://github.com/github/stale-repos) ⭐ 202 | 🐛 2 | 🌐 Python | 📅 2026-08-13 - Get a regular report of inactive repositories in your organization so that you can choose to archive or revive.
* [Sheriff](https://github.com/electron/sheriff) ⭐ 152 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-17 - Controls and monitors organization permissions across GitHub, Slack and GSuite.
...
* [Linguist](https://github.com/github-linguist/linguist) ⭐ 13,641 | 🐛 227 | 🌐 Ruby | 📅 2026-08-16 - Identify the programming languages used in a project.
...
* [DependencyTrack](https://github.com/DependencyTrack/dependency-track) ⭐ 4,118 | 🐛 1,077 | 🌐 Java | 📅 2026-08-17 - An intelligent component analysis platform that allows organizations to identify and reduce risk in the software supply chain.
* [ScanCode toolkit](https://github.com/aboutcode-org/scancode-toolkit) ⭐ 2,603 | 🐛 1,669 | 🌐 Python | 📅 2026-08-15 - Scan code for licenses, copyright and dependencies.
...
* [fossa-cli](https://github.com/fossas/fossa-cli) ⭐ 1,515 | 🐛 18 | 🌐 Haskell | 📅 2026-08-12 - Fast, portable and reliable dependency analysis for any codebase.
...
* [Licensee](https://github.com/licensee/licensee) ⭐ 904 | 🐛 8 | 🌐 Ruby | 📅 2026-08-17 - Identify a project's license file.
