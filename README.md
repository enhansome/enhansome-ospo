...
* [devstats](https://github.com/cncf/devstats) ⭐ 129 | 🐛 16 | 🌐 Shell | 📅 2026-07-31 - A toolset to visualize GitHub archives using Grafana dashboards used by the Cloud Native Computing Foundation and Kubernetes.
...
* [(Corporate) Git Proxy](https://github.com/finos/git-proxy) ⭐ 238 | 🐛 113 | 🌐 TypeScript | 📅 2026-08-16 - Scan outgoing attempts to push to public repository and raise compliance/info-sec friendly checks before allowing the push to complete.
...
* [Linguist](https://github.com/github-linguist/linguist) ⭐ 13,643 | 🐛 229 | 🌐 Ruby | 📅 2026-08-16 - Identify the programming languages used in a project.
...
* [DependencyTrack](https://github.com/DependencyTrack/dependency-track) ⭐ 4,116 | 🐛 1,079 | 🌐 Java | 📅 2026-08-15 - An intelligent component analysis platform that allows organizations to identify and reduce risk in the software supply chain.
* [ScanCode toolkit](https://github.com/aboutcode-org/scancode-toolkit) ⭐ 2,603 | 🐛 1,665 | 🌐 Python | 📅 2026-08-15 - Scan code for licenses, copyright and dependencies.
...
* [fossa-cli](https://github.com/fossas/fossa-cli) ⭐ 1,514 | 🐛 18 | 🌐 Haskell | 📅 2026-08-12 - Fast, portable and reliable dependency analysis for any codebase.
